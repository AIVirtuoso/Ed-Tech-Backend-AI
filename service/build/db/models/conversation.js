...
export const getChatConversations = async ({ referenceId, reference }) => {
...
export const getChatConversationId = async ({ referenceId, reference, topic, subject, level }, createNew = true) => {
...
export const createNewConversation = async ({ referenceId, reference, title, topic, subject, level }) => {
 ...
 */
export const chatHasTitle = async (conversationId) => {
 ...
 */
export const storeChatTitle = async (conversationId, title) => {
    const chat = await Conversation.findByPk(conversationId);
    if (!chat) {
